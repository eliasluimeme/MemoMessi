...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background/80 relative overflow-hidden">
      ...
      <div className="relative z-10 mx-auto w-full max-w-md rounded-[32px] border border-border/40 bg-card/20 backdrop-blur-3xl p-8 md:p-12 shadow-[0_8px_32px_rgba(0,0,0,0.12)]">
        ...
        <p className="mt-2 text-sm text-muted-foreground font-light tracking-wide text-center">
          Authenticate to access institutional intelligence
        </p>

        <form className="my-10" onSubmit={handleSubmit}>
          <LabelInputContainer className="mb-5">
            <Label htmlFor="email" className="text-xs uppercase tracking-widest text-muted-foreground font-semibold">Operator Email</Label>
            <Input
              id="email"
              name="email"
        ...
        <div className="text-center pt-6 border-t border-border/40">
          <Link href="/signup" className="text-xs font-medium text-muted-foreground hover:text-foreground transition-colors uppercase tracking-widest">
            Request Access &rarr;
          </Link>
        </div>
      </div>
